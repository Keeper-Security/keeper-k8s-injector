...
**Wait for it:** This command will wait (up to 2 minutes) until the pod is fully running, then automatically exit. You don't need to check manually - when the command completes, your pod is ready!
